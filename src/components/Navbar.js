  ...
  return (
    <nav tw="border-b-2">
      <div tw="bg-gray-200 p-2 flex flex-row items-center justify-between border-red-200">
        <div tw="flex flex-row items-center justify-center bg-white p-2 ml-6 border-primary rounded-lg">
          <IoLocationSharp />
          <p>Nigeria</p>
        </div>
        <div tw="flex flex-row items-center">
          <div tw="bg-white border-2 border-primary rounded-bl-lg rounded-tl-lg">
            <input
              type="text"
              placeholder="Search"
          ...
          <div tw="px-6 py-2 bg-primary border-primary text-white rounded-tr-lg rounded-br-lg">
      ...
      <div tw="flex text-center p-4 items-center justify-between text-lg gap-3">
        ...
        <div>
          <select name="hello" id="" tw="bg-white outline-none">
            <option value="services&handwork">Hire a Pro</option>
        ...
        <div tw="flex gap-6 items-center">
          ...
          <button tw="bg-primary text-white rounded-lg text-center justify-self-end p-2 mr-6">
            <p>Sell</p>
          </button>
        </div>
      </div>
